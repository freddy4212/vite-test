<!--Change to TS and Composition API-->
			...
			<div class="col-md-6" v-for="bookDetail in newArrivals">
				<div
					...
					<div class="col p-4 d-flex flex-column position-static">
						<strong class="d-inline-block mb-2 text-primary book-category">{{ bookDetail.category
							}}</strong>
						...
						<div class="input-group">
							...
							<button @click="addToCart(bookDetail)" class="btn btn-outline-secondary add-to-cart"
								type="button"><img src="/images-cloud/basket_icon.svg" alt="Add to basket"></button>
						</div>
